...
export const capstone: Project = {
  ...
  outcome:
    "Site público no estilo Linktree/vitrine: imagens de produto, clique abre Amazon/Mercado Livre. Admin seu. Stats de clique.",
  allowed: [
...
export const micros: Project[] = [
  {
    ...
    allowed: ["HTML", "CSS", "JS/TS", "GitHub Pages"],
    forbidden: ["React", "Next", "Tailwind", "libs de animação"],
    rubric: ["Sem overflow em 390", "Filtro funciona", "Product tipado", "README + print"],
  ...
  },
  {
    ...
    allowed: ["Next", "TS", "Tailwind + CSS vars"],
    forbidden: ["banco", "auth", "GSAP ainda (entra S13)"],
    rubric: ["URL", "3 cards", "página de produto", "zero any"],
  ...
  },
  {
    ...
    allowed: ["Fastify", "pg", "SQL files"],
    forbidden: ["Prisma", "Nest", "ORMs"],
    rubric: ["schema reproduzível", "inject tests", "401 no admin"],
  ...
  },
  {
    ...
    allowed: ["Next ou Fastify", "Stripe test", "PIX"],
    forbidden: ["grudar na Vitrine", "produção com dinheiro real no ano 1 se não precisar"],
    rubric: ["pagamento test pago", "webhook idempotente", "README: afiliado ≠ checkout"],
    repoHint: "checkout-1",
  },
  {
    id: "scroll-video",
    ...
    allowed: ["GSAP", "canvas/spritesheet", "IA para o clip"],
    forbidden: ["WebGL obrigatório", "prender scroll sem fallback"],
    rubric: ["390px usável", "fallback", "URL", "take no Android"],
  ...
  },
  {
    ...
    allowed: ["Go", "Gin", "database/sql"],
    forbidden: ["segundo capstone", "microserviços"],
    rubric: ["go test verde", "SQL parametrizado", "README de nível (não sênior)"],
    repoHint: "go-catalog",
  },
  {
    id: "pwa-cap",
    ...
    forbidden: ["Ionic UI", "Play Store", "React Native"],
